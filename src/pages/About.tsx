      ...
      <main className="flex-1">
        ...
        <section className="bg-hero-gradient text-primary-foreground py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">About Kenya Imports</h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Bringing Quality Vehicles to Kenya Since 2015
                </h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Kenya Imports was founded with a simple mission: to make premium vehicle importation
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <Card className="p-6 text-center border-2 hover:border-primary transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground">Source Countries</p>
                </Card>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description: "Every vehicle is thoroughly inspected to meet our high standards before shipment.",
                },
                {
                  icon: Heart,
                ...
                },
                {
                  ...
                  description: "Strong partnerships worldwide ensure access to the best vehicles at competitive prices.",
                },
                {
                  icon: Award,
                  title: "Excellence",
                  description: "We strive for excellence in every aspect of our service, from sourcing to delivery.",
                },
                {
                  icon: Users,
                  title: "Expertise",
                  description: "Our experienced team brings years of industry knowledge to serve you better.",
                },
                {
                  icon: Target,
                  title: "Transparency",
                ...
                <Card key={index} className="p-6 text-center border-2 hover:border-primary hover:shadow-large transition-all group">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  description: "Expert in logistics & shipping",
                },
                {
                  name: "David Omondi",
                ...
                <Card key={index} className="p-6 text-center border-2 hover:border-primary hover:shadow-large transition-all">
